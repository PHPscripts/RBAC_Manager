...
<?php if ($account_access->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_access->SortUrl($account_access->id) ?>',1);"><span id="elh_account_access_id" class="account_access_id">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_access->id->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_access->id->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_access->id->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
...
<?php if ($account_access->RealmID->Visible) { // RealmID ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_access->SortUrl($account_access->RealmID) ?>',1);"><span id="elh_account_access_RealmID" class="account_access_RealmID">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_access->RealmID->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_access->RealmID->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_access->RealmID->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<!--first page button-->
	...
	<td><a href="<?php echo $account_access_list->PageUrl() ?>start=<?php echo $account_access_list->Pager->FirstButton->Start ?>"><img src="phpimages/first.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" style="border: 0;"></a></td>
	<?php } else { ?>
	<td><img src="phpimages/firstdisab.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" style="border: 0;"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($account_access_list->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $account_access_list->PageUrl() ?>start=<?php echo $account_access_list->Pager->PrevButton->Start ?>"><img src="phpimages/prev.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" style="border: 0;"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="<?php echo $account_access_list->PageUrl() ?>start=<?php echo $account_access_list->Pager->NextButton->Start ?>"><img src="phpimages/next.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" style="border: 0;"></a></td>	
	<?php } else { ?>
	<td><img src="phpimages/nextdisab.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" style="border: 0;"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($account_access_list->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $account_access_list->PageUrl() ?>start=<?php echo $account_access_list->Pager->LastButton->Start ?>"><img src="phpimages/last.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" style="border: 0;"></a></td>	
	<?php } else { ?>
