...
//
// Table class for rbac_permissions
//
class crbac_permissions extends cTable {
	var $id;
	var $name;
	...
	// Update Table
	var $UpdateTable = "`rbac_permissions`";
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "rbac_permissionslist.php";
		}
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("rbac_permissionsview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "rbac_permissionsadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("rbac_permissionsedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("rbac_permissionsadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("rbac_permissionsdelete.php", $this->UrlParm());
	}
