...
<a href="javascript:faccount_bannedlistsrch.ToggleSearchPanel();" style="text-decoration: none;"><img id="faccount_bannedlistsrch_SearchImage" src="phpimages/collapse.gif" alt="" width="9" height="9" style="border: 0;"></a><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("Search") ?></span><br>
...
<?php if ($account_banned->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->id) ?>',1);"><span id="elh_account_banned_id" class="account_banned_id">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->id->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->id->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->id->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($account_banned->bandate->Visible) { // bandate ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->bandate) ?>',1);"><span id="elh_account_banned_bandate" class="account_banned_bandate">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->bandate->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->bandate->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->bandate->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($account_banned->unbandate->Visible) { // unbandate ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->unbandate) ?>',1);"><span id="elh_account_banned_unbandate" class="account_banned_unbandate">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->unbandate->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->unbandate->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->unbandate->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($account_banned->bannedby->Visible) { // bannedby ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->bannedby) ?>',1);"><span id="elh_account_banned_bannedby" class="account_banned_bannedby">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->bannedby->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->bannedby->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->bannedby->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($account_banned->banreason->Visible) { // banreason ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->banreason) ?>',1);"><span id="elh_account_banned_banreason" class="account_banned_banreason">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->banreason->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->banreason->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->banreason->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php if ($account_banned->active->Visible) { // active ?>
	...
	<?php } else { ?>
		<td><div onmousedown="ew_Sort(event,'<?php echo $account_banned->SortUrl($account_banned->active) ?>',1);"><span id="elh_account_banned_active" class="account_banned_active">
			<table class="ewTableHeaderBtn"><thead><tr><td class="ewTableHeaderCaption"><?php echo $account_banned->active->FldCaption() ?></td><td class="ewTableHeaderSort"><?php if ($account_banned->active->getSort() == "ASC") { ?><img src="phpimages/sortup.gif" width="10" height="9" alt="" style="border: 0;"><?php } elseif ($account_banned->active->getSort() == "DESC") { ?><img src="phpimages/sortdown.gif" width="10" height="9" alt="" style="border: 0;"><?php } ?></td></tr></thead></table>
		</span></div></td>		
	<?php } ?>
<?php } ?>		
<?php
...
<!--first page button-->
	...
	<td><a href="<?php echo $account_banned_list->PageUrl() ?>start=<?php echo $account_banned_list->Pager->FirstButton->Start ?>"><img src="phpimages/first.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" style="border: 0;"></a></td>
	<?php } else { ?>
	<td><img src="phpimages/firstdisab.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" style="border: 0;"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($account_banned_list->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $account_banned_list->PageUrl() ?>start=<?php echo $account_banned_list->Pager->PrevButton->Start ?>"><img src="phpimages/prev.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" style="border: 0;"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="<?php echo $account_banned_list->PageUrl() ?>start=<?php echo $account_banned_list->Pager->NextButton->Start ?>"><img src="phpimages/next.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" style="border: 0;"></a></td>	
	<?php } else { ?>
	<td><img src="phpimages/nextdisab.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" style="border: 0;"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($account_banned_list->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $account_banned_list->PageUrl() ?>start=<?php echo $account_banned_list->Pager->LastButton->Start ?>"><img src="phpimages/last.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" style="border: 0;"></a></td>	
	<?php } else { ?>
