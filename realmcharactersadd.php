...
$realmcharacters_add = NULL; // Initialize page object first

class crealmcharacters_add extends crealmcharacters {
	...
	// Page object name
	var $PageObjName = 'realmcharacters_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["acctid"] != "") {
				...
				$this->setKey("acctid", $this->acctid->CurrentValue); // Set up key
			} else {
				$this->setKey("acctid", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "realmcharactersview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// Check if key value entered
		if ($bInsertRow && $this->ValidateKey && $this->acctid->CurrentValue == "" && $this->acctid->getSessionValue() == "") {
			$this->setFailureMessage($Language->Phrase("InvalidKeyValue"));
			$bInsertRow = FALSE;
		}
...
// Create page object
if (!isset($realmcharacters_add)) $realmcharacters_add = new crealmcharacters_add();

// Page init
$realmcharacters_add->Page_Init();

// Page main
$realmcharacters_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var realmcharacters_add = new ew_Page("realmcharacters_add");
realmcharacters_add.PageID = "add"; // Page ID
var EW_PAGE_ID = realmcharacters_add.PageID; // For backward compatibility

// Form object
var frealmcharactersadd = new ew_Form("frealmcharactersadd");

// Validate form
frealmcharactersadd.Validate = function(fobj) {
...
frealmcharactersadd.Form_CustomValidate = 
...
frealmcharactersadd.ValidateRequired = true;
<?php } else { ?>
frealmcharactersadd.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $realmcharacters->TableCaption() ?></span></p>
...
<?php $realmcharacters_add->ShowPageHeader(); ?>
<?php
$realmcharacters_add->ShowMessage();
?>
<form name="frealmcharactersadd" id="frealmcharactersadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="realmcharacters">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_realmcharactersadd" class="ewTable">
</table>
</div>
</td></tr></table>
<br>
...
<script type="text/javascript">
frealmcharactersadd.Init();
</script>
<?php
$realmcharacters_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$realmcharacters_add->Page_Terminate();
?>
