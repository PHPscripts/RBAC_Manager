...
//
// Table class for account_banned
//
class caccount_banned extends cTable {
	var $id;
	var $bandate;
	var $unbandate;
	var $bannedby;
	...
	function __construct() {
		...
		$this->TableVar = 'account_banned';
		$this->TableName = 'account_banned';
		...
		// id
		$this->id = new cField('account_banned', 'account_banned', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// bandate
		$this->bandate = new cField('account_banned', 'account_banned', 'x_bandate', 'bandate', '`bandate`', '`bandate`', 19, 9, FALSE, '`bandate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->bandate->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['bandate'] = &$this->bandate;

		// unbandate
		$this->unbandate = new cField('account_banned', 'account_banned', 'x_unbandate', 'unbandate', '`unbandate`', '`unbandate`', 19, 9, FALSE, '`unbandate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->unbandate->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['unbandate'] = &$this->unbandate;

		// bannedby
		$this->bannedby = new cField('account_banned', 'account_banned', 'x_bannedby', 'bannedby', '`bannedby`', '`bannedby`', 200, -1, FALSE, '`bannedby`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['bannedby'] = &$this->bannedby;

		// banreason
		$this->banreason = new cField('account_banned', 'account_banned', 'x_banreason', 'banreason', '`banreason`', '`banreason`', 200, -1, FALSE, '`banreason`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['banreason'] = &$this->banreason;

		// active
		$this->active = new cField('account_banned', 'account_banned', 'x_active', 'active', '`active`', '`active`', 17, -1, FALSE, '`active`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`account_banned`";
	...
	function SqlKeyFilter() {
		return "`id` = @id@ AND `bandate` = @bandate@";
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("account_bannedview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "account_bannedadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("account_bannededit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("account_bannedadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("account_banneddelete.php", $this->UrlParm());
	}
