...
$uptime_edit = NULL; // Initialize page object first

class cuptime_edit extends cuptime {
	...
	function Page_Main() {
		...
		if ($this->realmid->CurrentValue == "")
			$this->Page_Terminate("uptimelist.php"); // Invalid key, return to list
		if ($this->starttime->CurrentValue == "")
			$this->Page_Terminate("uptimelist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("uptimelist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
...
// Create page object
if (!isset($uptime_edit)) $uptime_edit = new cuptime_edit();

// Page init
$uptime_edit->Page_Init();

// Page main
$uptime_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uptime_edit = new ew_Page("uptime_edit");
uptime_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = uptime_edit.PageID; // For backward compatibility

// Form object
var fuptimeedit = new ew_Form("fuptimeedit");

// Validate form
fuptimeedit.Validate = function(fobj) {
...
fuptimeedit.Form_CustomValidate = 
...
fuptimeedit.ValidateRequired = true;
<?php } else { ?>
fuptimeedit.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $uptime->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $uptime->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $uptime_edit->ShowPageHeader(); ?>
<?php
$uptime_edit->ShowMessage();
?>
<form name="fuptimeedit" id="fuptimeedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="uptime">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_uptimeedit" class="ewTable">
</table>
</div>
</td></tr></table>
<input type="hidden" name="x_realmid" id="x_realmid" value="<?php echo ew_HtmlEncode($uptime->realmid->CurrentValue) ?>">
<input type="hidden" name="x_starttime" id="x_starttime" value="<?php echo ew_HtmlEncode($uptime->starttime->CurrentValue) ?>">
<br>
