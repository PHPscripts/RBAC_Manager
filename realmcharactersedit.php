...
$realmcharacters_edit = NULL; // Initialize page object first

class crealmcharacters_edit extends crealmcharacters {
	...
	// Page object name
	var $PageObjName = 'realmcharacters_edit';
	...
	function Page_Main() {
		...
		if ($this->realmid->CurrentValue == "")
			$this->Page_Terminate("realmcharacterslist.php"); // Invalid key, return to list
		if ($this->acctid->CurrentValue == "")
			$this->Page_Terminate("realmcharacterslist.php"); // Invalid key, return to list
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("realmcharacterslist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
	...
	function LoadFormValues() {
		...
		if (!$this->acctid->FldIsDetailKey)
			$this->acctid->setFormValue($objForm->GetValue("x_acctid"));
	}
...
// Create page object
if (!isset($realmcharacters_edit)) $realmcharacters_edit = new crealmcharacters_edit();

// Page init
$realmcharacters_edit->Page_Init();

// Page main
$realmcharacters_edit->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var realmcharacters_edit = new ew_Page("realmcharacters_edit");
realmcharacters_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = realmcharacters_edit.PageID; // For backward compatibility

// Form object
var frealmcharactersedit = new ew_Form("frealmcharactersedit");

// Validate form
frealmcharactersedit.Validate = function(fobj) {
...
frealmcharactersedit.Form_CustomValidate = 
...
frealmcharactersedit.ValidateRequired = true;
<?php } else { ?>
frealmcharactersedit.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Edit") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $realmcharacters->TableCaption() ?></span></p>
...
<?php $realmcharacters_edit->ShowPageHeader(); ?>
<?php
$realmcharacters_edit->ShowMessage();
?>
<form name="frealmcharactersedit" id="frealmcharactersedit" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="realmcharacters">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_realmcharactersedit" class="ewTable">
</table>
</div>
</td></tr></table>
<input type="hidden" name="x_realmid" id="x_realmid" value="<?php echo ew_HtmlEncode($realmcharacters->realmid->CurrentValue) ?>">
<input type="hidden" name="x_acctid" id="x_acctid" value="<?php echo ew_HtmlEncode($realmcharacters->acctid->CurrentValue) ?>">
<br>
<input type="submit" name="btnAction" id="btnAction" value="<?php echo ew_BtnCaption($Language->Phrase("EditBtn")) ?>">
</form>
<script type="text/javascript">
frealmcharactersedit.Init();
</script>
<?php
$realmcharacters_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$realmcharacters_edit->Page_Terminate();
?>
