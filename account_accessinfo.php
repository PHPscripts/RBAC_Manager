...
//
// Table class for account_access
//
class caccount_access extends cTable {
	var $id;
	var $gmlevel;
	var $RealmID;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('account_access', 'account_access', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// gmlevel
		$this->gmlevel = new cField('account_access', 'account_access', 'x_gmlevel', 'gmlevel', '`gmlevel`', '`gmlevel`', 17, -1, FALSE, '`gmlevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->gmlevel->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['gmlevel'] = &$this->gmlevel;

		// RealmID
		$this->RealmID = new cField('account_access', 'account_access', 'x_RealmID', 'RealmID', '`RealmID`', '`RealmID`', 3, -1, FALSE, '`RealmID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// Update Table
	var $UpdateTable = "`account_access`";
	...
	function SqlKeyFilter() {
		return "`id` = @id@ AND `RealmID` = @RealmID@";
	}
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("account_accessview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "account_accessadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("account_accessedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("account_accessadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("account_accessdelete.php", $this->UrlParm());
	}
	...
	function GetKeyFilter() {
		...
		foreach ($arKeys as $key) {
			...
			$this->RealmID->CurrentValue = $key[1];
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->gmlevel->Exportable) $Doc->ExportCaption($this->gmlevel);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->gmlevel->Exportable) $Doc->ExportField($this->gmlevel);
