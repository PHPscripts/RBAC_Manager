...
$uptime_add = NULL; // Initialize page object first

class cuptime_add extends cuptime {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["starttime"] != "") {
				...
				$this->setKey("starttime", $this->starttime->CurrentValue); // Set up key
			} else {
				$this->setKey("starttime", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "uptimeview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// Check if key value entered
		if ($bInsertRow && $this->ValidateKey && $this->starttime->CurrentValue == "" && $this->starttime->getSessionValue() == "") {
			$this->setFailureMessage($Language->Phrase("InvalidKeyValue"));
			$bInsertRow = FALSE;
		}
...
// Create page object
if (!isset($uptime_add)) $uptime_add = new cuptime_add();

// Page init
$uptime_add->Page_Init();

// Page main
$uptime_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var uptime_add = new ew_Page("uptime_add");
uptime_add.PageID = "add"; // Page ID
var EW_PAGE_ID = uptime_add.PageID; // For backward compatibility

// Form object
var fuptimeadd = new ew_Form("fuptimeadd");

// Validate form
fuptimeadd.Validate = function(fobj) {
...
fuptimeadd.Form_CustomValidate = 
...
fuptimeadd.ValidateRequired = true;
<?php } else { ?>
fuptimeadd.ValidateRequired = false; 
<?php } ?>
...
<p><span id="ewPageCaption" class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $uptime->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $uptime->getReturnUrl() ?>" id="a_GoBack" class="ewLink"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $uptime_add->ShowPageHeader(); ?>
<?php
$uptime_add->ShowMessage();
?>
<form name="fuptimeadd" id="fuptimeadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<br>
<input type="hidden" name="t" value="uptime">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table id="tbl_uptimeadd" class="ewTable">
</table>
</div>
</td></tr></table>
<br>
